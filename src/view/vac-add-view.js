      ...
      >
        {({ values, touched, setFieldValue, setTouched, resetForm }) => (
          <>
            ...
            <Button type="primary" form="vacancyForm" >Отправить</Button>
            <Button type="primary" onClick={(e) => { e.preventDefault(); resetForm(); }} >Сбросить</Button>
          </>
        )}
      </Formik>
    </label>
...
VacAddView.defaultProps = { initialValues };
